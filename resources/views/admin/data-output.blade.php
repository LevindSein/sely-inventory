...
@section('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Log Output Barang</h1>
          </div>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabel Log Output</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="tableBarang" width="100%" cellspacing="0">
                  ...
                  ?>
                    <tr>
                      ...
                      <td>{{$d->jumlah_output}}</td>
                      <td class="text-left">{{$d->tujuan_output}}</td>
